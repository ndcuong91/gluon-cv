# prepare train.lst, train.rec, val.lst, val.rec
...
if (training==True):
    root='/media/atsg/Data/CuongND/challenge/zaloAIchallenge/landmark/data/TrainVal/train'
    prefix='train'
    no_shuffle=False
else:
    root='/media/atsg/Data/CuongND/challenge/zaloAIchallenge/landmark/data/TrainVal/val'
    prefix='val'
    no_shuffle=True
...
def parse_args():
    ...
    #parser.add_argument('prefix', help='prefix of input/output lst and rec files.', default=prefix)
    #parser.add_argument('root', help='path to folder containing images.', default=root)

    cgroup = parser.add_argument_group('Options for creating image lists')
    cgroup.add_argument('--list', default=pack_list,
    ...
    cgroup.add_argument('--recursive', default=recursive,
                        help='If true recursively walk through subdirs and assign an unique label\
        to images in each folder. Otherwise only include images in the root folder\
        and give them label 0.')
    cgroup.add_argument('--no-shuffle', dest='shuffle', default=no_shuffle,
                        help='If this is passed, \
        im2rec will not randomize the image order in <prefix>.lst')
    rgroup = parser.add_argument_group('Options for creating database')
    rgroup.add_argument('--pass-through', default=pass_through,
    ...
    rgroup.add_argument('--num-thread', type=int, default=num_thread,
    ...
    rgroup.add_argument('--pack-label', default=pack_label,
        help='Whether to also pack multi dimensional label in the record file')
    args = parser.parse_args()
    args.prefix = os.path.abspath(prefix)
