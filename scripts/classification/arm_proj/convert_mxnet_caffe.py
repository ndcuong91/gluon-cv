...
CAFFE_NET = 'arm_v4.5.3.prototxt'
CAFFE_MODEL = 'arm_v4.5.3.caffemodel' #training model from Caffe with batchnorm layer

MXNET_MODEL = 'arm_v4.5.3_9209.params' #only for reference
